...
1. Create ansible playbooks to create **[deployment](https://github.com/loveguptapp/setup_devops/blob/main/kubernetes-valaxy-deployment.yml)** and **[services](https://github.com/loveguptapp/setup_devops/blob/main/kubernetes-valaxy-service.yml)** 
